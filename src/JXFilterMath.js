...
THREE.JX.JXFilterMath = {
     ...
     * */
        ...
        function singleButterflyCal(start, end, n){
            ...
            for(var i = start, j = 0; i <= (end - delta); i ++){
                ...
                if(!(dataArr[i] instanceof THREE.JX.JXFilterMath.M.C)) dataArr[i] = new THREE.JX.JXFilterMath.M.C(dataArr[i]);

                if(!(dataArr[pairI] instanceof THREE.JX.JXFilterMath.M.C)) dataArr[pairI] = new THREE.JX.JXFilterMath.M.C(dataArr[pairI]);
    ...
    exp: function(theta,r){//  r e^(i * theta) = r cos theta + r i * sin theta
        ...
        var tempC = new THREE.JX.JXFilterMath.M.C();
    ...
    applyMatrix: function(imgData,matrixArr,low){//对图象信号实行掩模算子变换 low为阈值,滤波运算
        ...
        var template = new THREE.JX.JXFilterMath.Matrix(matrixArr,matrixSize,1);                
        var tempData = [];
        ...
        for(var i = 0,n = data.length;i < n;i += 4){
            ...
            var pixelMatrix = new THREE.JX.JXFilterMath.Matrix(pixelArr,3,matrixSize);
    ...
    distance: function(p1, p2){
        ...
        p1 = new THREE.JX.JXFilterMath.M.C(p1[0], p1[1]);
        p2 = new THREE.JX.JXFilterMath.M.C(p2[0], p2[1]);
...
/*
var t = THREE.JX.JXFilterMath.M.RGBToHSI(255,5,25);
var f = THREE.JX.JXFilterMath.M.HSIToRGB(t.H+2 * Math.PI,t.S,t.I);
alert(f.R + "|" + f.G + "|" + f.B);
*/

THREE.JX.JXFilterMath.Matrix.prototype = {
    /*m: 0,//数学上传统的m*n矩阵
    n: 0,
*/
    plus: function(matrix){
        ...
        var tempM = new THREE.JX.JXFilterMath.M.Matrix([],this.m,this.n);
    ...
    mutiply: function(matrix){//左乘另一矩阵
        ...
        var tempM = new THREE.JX.JXFilterMath.Matrix([],this.m,matrix.n);
        for(var i = 0;i < this.m;i ++){
...
THREE.JX.JXFilterMath.C.prototype = {
    plus: function(c){
        var tempC = new THREE.JX.JXFilterMath.M.C();
        tempC.r = this.r + c.r;
        tempC.i = this.i + c.i;
    ...
    conjugated: function(){//取共轭
        var tempC = new THREE.JX.JXFilterMath.M.C(this.r,-this.i);
        return tempC;
    },
